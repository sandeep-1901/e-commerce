...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
  ...
  $exist=false;
    ...
    $sql="SELECT * FROM `category` WHERE `username` LIKE '$username' AND `password` LIKE '$password'";
...
?>
    ...
    <div class="container " >
   <h1 class="text-center">log in as user</h1>
   <form action="/E_COMMERCE/luser.php" method="post" >
