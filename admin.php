...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
  ...
  if($username==''or$password=''or$cpassword='')
  {
   ...
   if(($password==$cpassword)&& ($exist==false))
   {
    ...
    $sql="INSERT INTO `admin` (`username`, `password`, `date`) VALUES ('$username', '$password', current_timestamp(6))";
...
if($showError)
{
  ...
  <h4 class="alert-heading">eneter the correct password!</h4>
...
?>
   ...
   <form action="/E_COMMERCE/admin.php" method="post" >
